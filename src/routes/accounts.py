...
async def register_user(
    ...
    Args:
        ...
        background_tasks: BackgroundTasks
        email_notification: EmailSenderInterface
...
async def activate_account(
    ...
    background_tasks.add_task(
        email_notification.send_activation_complete_email, str(user.email), url
    )
...
async def reset_password(
    ...
    background_tasks.add_task(
        email_notification.send_password_reset_complete_email, str(user.email), url
    )
